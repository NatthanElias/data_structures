...
//Enqueue
bool enfileiraF(Fila *f, Doc dado)
{
...
string espiaNome(Fila* f)
{
    string dado;

    if (vaziaF(f) == false) //verifica se a fila não está vazia, ou seja, (f->inicio != NULL)
    {
        dado = f->inicio->dado.nome;
    }
